#!/usr/bin/env python3
"""
Concordia Contest Sandbox Adapter for Sandbox-RLX

将Concordia Contest的文本交互环境适配到Sandbox-RLX框架中
...
class ConcordiaSandbox(Sandbox):
...
Action:"""
    ...
    def verify_score(self, action_text: str, case: Dict[str, Any]) -> float:
        """验证动作并计算奖励"""
        # 构建所有角色的动作
