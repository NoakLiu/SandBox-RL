#!/usr/bin/env python3
"""
Sandbox-RL Dynamic Graph Visualizer
...
class SandboxRLVisualizer:
    ...
    def __init__(self, 
        ...
        logger.info("Sandbox-RL可视化器初始化完成")
    ...
    def _update_visualization(self, frame):
        ...
        self.ax.set_title(f'Sandbox-RL Visualization - Time: {self.current_time:.1f}s')
...
# 工厂函数
def create_sandgraph_visualizer(log_file: str = "sandgraph_visualization.log") -> SandboxRLVisualizer:
    """创建Sandbox-RL可视化器"""
    return Sandbox-RLVisualizer(log_file)
