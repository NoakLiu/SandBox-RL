...
from oasis_core_integration import OASISCoreVLLMSimulation

async def run_oasis_core_simulation():
    """运行OASIS核心仿真"""
    print("🚀 启动OASIS核心vLLM仿真...")
    ...
    try:
        ...
        # 保存结果
        simulation.save_results("oasis_core_vllm_simulation_test.json")
        
        print("✅ 仿真完成")
        print(f"结果已保存到 oasis_core_vllm_simulation_test.json")
...
if __name__ == "__main__":
    asyncio.run(run_oasis_core_simulation()) 